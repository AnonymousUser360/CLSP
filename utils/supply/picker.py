...
# from game_zoo.fps.pipelines.v5.supply.supply_moule_item_info import all_supply_items, bag_level, bullet2gun
# from game_zoo.fps.pipelines.v5.supply.supply_type_info import SupplyType, AttachmentSubtype
...
def plan_gun(env_supplys, env_state, state):
    actions_seq = []
    snipe_cnt = 0
    for my_gun in state[SupplyType.GUN]:
