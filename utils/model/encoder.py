...
from .network.encoder import SignBinaryEncoder, BinaryEncoder, OnehotEncoder, TimeEncoder, UnsqueezeEncoder,FrequencyEncoder,GaussianEncoder,MultiScaleNormEncoder
    ...
    def __init__(self, cfg,name=str):
        ...
        for k, item in self.cfg.modules.items():
            if item['arc'] == 'time':
                ...
                self.encode_modules[k] = MultiScaleNormEncoder(embedding_dim=item['embedding_dim'], )
